...
class Game:
	def __init__(self):
		...
		self.image1id = self.image_renderer.render_image("fish", (WIDTH//2, HEIGHT//2,), (128, 128,), self.screen)
		self.image2id = self.image_renderer.render_image("fish", ((WIDTH//2)//2, (HEIGHT//2)//2,), (64, 64,), self.screen)
